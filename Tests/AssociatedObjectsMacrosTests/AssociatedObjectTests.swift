import XCTest
@testable import AssociatedObjectsMacros
...
final class AssociatedObjectTests: XCTestCase {
	func testMain() {
		...
		XCTAssertEqual(object.box.content, 0)
		object.box.content += 1
		XCTAssertEqual(object.box.content, 1)
	}
}
